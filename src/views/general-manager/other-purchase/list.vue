      ...
      <el-form :model="queryParams" ref="queryForm" inline class="search-form" label-width="80px">
        <div class="search-row">
          ...
          <!-- <el-form-item label="付款状态" prop="isPay">
            <el-select v-model="queryParams.isPay" placeholder="请选择" clearable style="width: 120px">
...
export default {
  ...
  methods: {
    ...
    handleView(row) {
      this.$router.push({
        path: "/general-manager/other-purchase/detail",
        query: { id: row.id }
      });
    },
    handleAudit(row) {
