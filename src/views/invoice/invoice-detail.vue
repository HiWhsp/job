                    ...
                    <section>
                        ...
                        <div class="item-info-box" v-if="info.type==1">
                            ...
                            <div class="item-info">
                                ...
                                <div class="val">￥{{ order_yunfei ? order_yunfei : '0.00' }}</div>
                            </div>
                            <div class="item-info">
                    ...
                    <section>
                        <div class="item-info-box">
                            <div class="item-info">
                                ...
                                <div class="val">{{ info.invoiceType == 1 ? '普通发票' : '专用发票' }}</div>
                            </div>
                            <div class="item-info">
                                <label class="label">发票抬头类型：</label>
                                <div class="val">{{ info.titleType == 1 ? '个人' : '公司' }}</div>
                            </div>
                            <div class="item-info">
                                ...
                                <div class="val">
                                    <div class="pic-info" v-if="fapiao_is_image">
                                        <div class="pic-list flex">
                                            <div class="pic-item" v-for="(pic, index) in pic_list" :key="index" alt>
                                                <el-image style="width: 120px;height: 120px;" :src="pic"
