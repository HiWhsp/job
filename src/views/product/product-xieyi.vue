          ...
          <div class="val" style="padding: 0">
            <div class="sort-box">
              ...
              >
                ...
                <div
                  class="sanjiao-box"
                  v-if="item.title != '综合排序' && item.title != '人气排序'"
                >
                  <div
                    class="top"
                    :class="
  ...
  data() {
    return {
      ...
      sortList: [
        ...
        { title: "人气排序", ziduan: "orders", orderType: 4, orderTyped: 0 },
        { title: "价格", ziduan: "priceSale", orderType: 2, orderType: 3 },
        { title: "销量", ziduan: "orders", orderType: 1, orderTyped: 1 },
        { title: "新品", ziduan: "orders", orderType: 5, orderTyped: 6 },
      ],
      chosenSort: {
        title: "综合排序",
        ziduan: "ordering",
