...
export default {
  ...
  computed: {
    ...
    opt_nav() {
      //个人中心
      let child_user = [
        {title: " 订单管理 ",route: "", child:[
          {title: " 我的订单 ",route: "/order-list",},
          {title: " 我的售后 ",route: "/refund-list",},
          {title: " 我的评价 ",route: "/my-review-list",},
        ]},
        {title: "我的活动",route: "",child:[
          {title: " 我的充值 ",route: "/balance-list",},
          {title: " 我的兑换卡 ",route: "/card-list",},
          {title: " 我的收藏 ",route: "/favorite-list",},
          {title: " 我的足迹 ",route: "/browse-history",},
        ]},
        {title: "个人资料",route: "", child:[
          {title: " 地址管理 ",route: "/address-list",},
          {title: " 我的发票 ",route: "/invoice-list",},
          {title: " 个人资料 ",route: "/my-info",},
          {title: " 修改密码 ",route: "/change-password",},
          {title: " 退出登录 ",route: "logout",},
        ]},
      ];

      //帮助中心
      let chlid_help = [
        {title: " 购物指南 ",route: "", child:[
          {title: " 购物保障 ",route: "/help?id=112",},
          {title: " 我的售后 ",route: "/refund-list",},
          {title: " 订单操作 ",route: "/help?id=113",},
        ]},
        {title: " 支付方式 ",route: "",child:[
          {title: " 微信支付 ",route: "/help?id=117",},
          {title: " 支付宝支付 ",route: "/help?id=118",},
        ]},
        {title: " 配送服务 ",route: "",child:[
          {title: " 配送范围 ",route: "/help?id=119",},
        ]},
        {title: " 售后服务 ",route: "", child:[
          {title: " 退货政策 ",route: "/help?id=122",},
          {title: " 退款方式 ",route: "/help?id=121",},
          {title: " 换货服务 ",route: "/help?id=120",},
        ]},
        {title: " 帮助信息 ",route: "", child:[
          {title: " 关于我们 ",route: "/help?id=124",},
          {title: " 联系我们 ",route: "/help?id=123",},
        ]},
      ];
      ...
      let arr = [
        { title: "首页", route: "/" },
        { title: "热卖产品", route: "/product-remai" },
        { title: "中科优选", route: "/product-youxuan" },
        { title: "充值中心", route: "/balance" },
        { title: "兑换卡", route: "/card" },
        { title: "帮助中心", route: "",child: chlid_help },
        { title: "个人中心", route: "/order-list", child: child_user },
        { title: "购物车", route: "/cart" },
        { title: "登录/注册", route: "/login"},
      ];
  ...
  methods: {
    ...
    toSearch() {
      ...
      // if (this.selectCate) {
      //   this.$router.push("/product-search?id=" + this.selectCate + "&keyword=" + this.keyword);
      // } else {
      //   this.$router.push("/product-search?keyword=" + this.keyword);
      // }
      ...
      this.$router.push({
        path: "/product-cates?keyword=" + this.keyword,
        // query: query,
      });
    },
