...
<script>
import page_header from "./comps/page_header.vue"; //
import page_footer from "./comps/page_footer.vue";
import page_header_mobile from "./comps/page_header_mobile.vue"; //移动端顶部
// import page_aside from "@/components/page/page_aside.vue";
// import page_kefu from "@/components/page/page_kefu.vue";
