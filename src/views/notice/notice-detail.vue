        ...
        <div class="content">
            <div class="top flex">
                ...
                <div class="info flex">
                    ...
                    <div class="desc"><span>来源：</span>奉新县砂轮行业协会</div>
                </div>
            </div>
            ...
            if (type == 'down') {
                ...
                for (let i = 0; i < this.allToBuy.length; i++) {
                    if (this.productsToBuy[1].id == this.allToBuy[i].id) {
                        ...
                        this.$router.push('/notice-detail?id=' + this.productsToBuy[1].id);
                    }
                }
            } else if (type == 'up') {
                ...
                for (let i = 0; i < this.allToBuy.length; i++) {
                    if (this.productsToBuy[0].id == this.allToBuy[i].id) {
                        ...
                        sessionStorage.setItem("productsToBuy", JSON.stringify([start, end]));
                        sessionStorage.setItem("allToBuy", JSON.stringify(this.allToBuy));
                        this.$router.push('/notice-detail?id=' + this.productsToBuy[0].id);
                    }
                }
            }
            location.reload();
