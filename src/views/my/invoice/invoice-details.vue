<template>
  <div class="page">
    <div class="main-title">
      <span>发票详情</span>
      <button @click="$router.push('/invoice-list')">返回</button>
    </div>
        ...
        <div class="order-list-wrap">
          ...
          <div class="info-item">
                ...
                <div class="item">
                  <div class="item-good flex">
                    <div class="box-image cover">
                      <el-image :src="JSON.parse(info.info)[0].image">
                        <div slot="error" class="image-slot">
                          <img :src="JSON.parse(info.info)[0].image"/>
                        </div>
                      </el-image>
                    </div>
                    <div class="box-title">
                      <div class="title">
                        {{ JSON.parse(info.info)[0].title }}
                      </div>
                      <div class="box-sku">
                        <div class="goods-sku">型号：{{ JSON.parse(info.info)[0].keyVals }}</div>
                      </div>
                    </div>

                    <div class="box-num">1</div>
                    <div class="box-price">{{ vuex_huobi }} {{ JSON.parse(info.info)[0].priceSale }}</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="info-cont">
              <div class="content">
                <div class="it">
                  <span>商品总价：{{ vuex_huobi }} {{ sum }}</span>
                </div>
                <div class="it">
                  <span>配送费：{{ vuex_huobi }} 0</span>
                </div>
                <div class="it">
                  <span>优惠券：{{ vuex_huobi }} 0</span>
                </div>
                <div class="it">
                  <span>合计应付：{{ vuex_huobi }} {{ sum }}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="other">
          <div class="item">
            <div class="item-content">
              ...
              <div class="it" v-if="info.invoiceType != 2">
                <span>开票类型：</span>
              ...
              <div class="it" v-if="info.invoiceType == 2 || info.titleType == 2">
                <span>纳税人识别码：</span>
                {{ info.shibiema }}
              </div>
              <div class="it" v-if="info.invoiceType == 2">
...
export default {
  ...
  computed: {
    ...
    sum() {
      const info = JSON.parse(this.info.info)[0];
      return Number(info.priceSale) * Number(info.num);
    }
  },
  watch: {
    orderObj(data) {
