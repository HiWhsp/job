      ...
      <div class="comment-box">
        <div class="form-box">
          ...
          <div class="upload-box">
            <el-upload class="upload-demo" list-type="picture-card" multiple accept="image/*" :name="upload_col_name" action="https://zsxhxxpx.dx.hdapp.com.cn/api?action=index_ossUpload" :on-success="uploadSuccess_pingjia" :before-upload="beforeUpload_pingjia" :data="uploadExtraData">
