        ...
        <div class="order-list-wrap">
          <div class="info-item" v-for="(item, index) in list" :key="index">
            <div class="info-title">
              ...
              <div class="order-state" :class="'state-' + item.orderStatus" v-if="tabSelect.value == 1">
                <img src="@/assets/img/refund/exchange.png" alt="" />换货
              </div>
            </div>
            <div class="info-good">
              <div class="list-good">
    ...
    methods: {
      ...
      onRouteTo() {
        this.$router.push({
          ...
          query: {
            status: 'exchange-goods-handling',
          }
        });
      },
    },
