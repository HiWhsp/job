<template>
  <div class="page">
    ...
    <div class="page-ctx">
      <div class="wait-review-wrap" v-if="status == 'exchange-goods-waiting'">
        <div class="title">等待审核</div>
        <div class="sub-title">等待平台确认换货</div>
      </div>

      <div
        class="wait-review-wrap"
        v-else-if="status == 'exchange-goods-handling'"
      >
      ...
      <div
        class="wait-review-wrap"
        v-else-if="status == 'exchange-goods-success'"
      >
      ...
      <div
        class="wait-review-wrap"
        v-else-if="status == 'confirm-receive-goods'"
      >
        <div class="title">换货成功</div>
        <div class="sub-title">换货已完成</div>
      </div>

      <div class="refund-message-wrap">
        <div class="refund-message">换货信息</div>
        <div class="form-wrap">
          <div class="form-item">
            <div class="label" style="line-height: normal">换货商品：</div>
            <div class="item">
              <div class="img-wrap">
                <img src="" alt="" />
              </div>
        ...
        <div class="address-wrap" v-if="status === 'exchange-goods-success'">
        ...
        <template v-else-if="status === 'exchange-goods-handling'">
          <div class="handling-form-wrap">
            <div class="handling-form-item">
              <div class="label">退还地址：</div>
              <div class="item">
                <div class="info-wrap">
                  <div class="name">张三 1810000000</div>
            ...
            <div class="handling-form-item" style="margin-top: 28px">
              <div class="label">快递公司：</div>
              <div class="item">
                <div class="info-wrap">
                  <div class="name">申通快递</div>
                </div>
              </div>
            </div>
            <div class="handling-form-item" style="margin-top: 17px">
              <div class="label">快递单号：</div>
              <div class="item">
                <div class="info-wrap">
                  <div class="name">145522112551542124225</div>
                </div>
              </div>
            </div>
            <div class="handling-form-item" style="margin-top: 17px">
              <div class="label">邮寄时间：</div>
              <div class="item">
                <div class="info-wrap">
                  <div class="name">2021-07-13 10:02:30</div>
                </div>
              </div>
            </div>
          </div>
          <div class="confirm-form-wrap">
            ...
            <div class="confirm-form-item" style="margin-top: 17px">
              <div class="label">快递单号：</div>
              <div class="item">
                <div class="info-wrap">
                  <div class="name">145522112551542124225</div>
            ...
            <div class="confirm-btn-wrap">
              <div class="confirm-btn" @click="confirmReceiveGoods">
                确认收货
              </div>
            </div>
          </div>
        </template>
        <template v-else-if="status === 'confirm-receive-goods'">
          <div class="handling-form-wrap">
            <div class="handling-form-item">
              <div class="label">退还地址：</div>
              <div class="item">
...
export default {
  ...
  methods: {
    ...
    confirmReceiveGoods() {
      this.status = "confirm-receive-goods";
    },
  },
};
</script>
