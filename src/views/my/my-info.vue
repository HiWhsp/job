          ...
          <div class="item upload-box">
            ...
            <span class="info">
              <div class="upload-box">
                < class="upload-demo" accept="image/*" :show-file-list="false" :name="UPLOAD_NAME"
                           action="http://fujunjixie.dx.hdapp.com.cn/service.php?action=index_ossUpload" :data="mix_upload_data" :on-success="upload_on_success"
