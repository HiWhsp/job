  ...
  <div class="page">
    <div class="inner">
          ...
          <div class="pay-group">
            ...
            <div class="pay-items">
              <div class="item" v-for="(item, index) in payTypeOption" @click="do_toggle_paytype(item)"
                   :class="{ checked: pay_type_value == item.value }" :key="index">
        ...
        <div class="section-ctx section-ctx-type">
          <div class="pay-group">
            ...
            <div class="pay-items">
              <div class="item" v-for="(item, index) in invoiceTypeOption" @click="do_toggle_invoice(item)"
                   :class="{ checked: Invoice_type_value == item.value }" :key="index">
          ...
          <div class="invoice-info" v-if="invoiceType == '普通发票'">
            ...
            <div class="info-item">
              ...
              <div class="info-val">
                <el-input v-model="webConfig.offline_bank" placeholder="请填写准确的抬头名称 必填"></el-input>
              </div>
            </div>
            <div class="info-item" v-if="webConfig.offline_bank == 2">
              <div class="info-label"><span>*</span> 纳税人识别号</div>
              <div class="info-val">
                <el-input v-model="webConfig.offline_bank" placeholder="请填写准确的纳税人识别号 必填"></el-input>
              </div>
            </div>
          </div>
          ...
          <div class="invoice-info" v-if="invoiceType == '专用发票'">
            ...
            <div class="info-item">
              ...
              <div class="info-val">
                <el-input v-model="webConfig.offline_bank" placeholder="输入单位注册地址 必填"></el-input>
              </div>
            </div>
            <div class="info-item">
              <div class="info-label"><span>*</span> 注册电话</div>
              <div class="info-val">
                <el-input v-model="webConfig.offline_bank" placeholder="输入单位注册电话 必填"></el-input>
              </div>
            </div>
            <div class="info-item">
      ...
      <div class="section section-product">
        ...
        <div class="section-ctx" style="background: #FAFBFC;">
            ...
            <div class="order-action" v-if="list_coupon.length">
              <div class="order-action-inner">
                <div class="section-item">
                  ...
                  <div class="sub-title flex" @click="showCoupon = !showCoupon" :class="{ 'expand-0': !showCoupon }">
      ...
      <!--      赠品-->
      <div class="section section-pay">
        <div class="section-title">赠品信息</div>
        <div class="section-ctx" style="background: #FAFBFC;">
          <div class="goods-list">
            <!-- <div class="title">订单商品</div> -->
            <div class="list">
...
export default {
  ...
  data() {
    return {
      ...
      payTypeOption: [
        {value: 'weixin', title: '微信支付', icon: ''},
        {value: 'zhifubao', title: '支付宝支付', icon: ''},
        {value: 'paypal', title: '货到付款', icon: ''},
        {value: 'xianxia', title: '线下支付', icon: ''},
