...
export default {
  ...
  computed: {
    ...
    tabList() {
      ...
      let tabList = [
        {value: 0, title: "全部订单"},
        {value: 1, title: "待支付", num: user_index.order_num_1 || 0},
        {value: 2, title: "待发货", num: user_index.order_num_2 || 0},
        {value: 3, title: "已发货", num: user_index.order_num_3 || 0},
        {value: 5, title: "已完成", num: user_index.order_num_5 || 0},
      ];
      return tabList;
    },
  },
  ...
  methods: {
    ...
    query_order() {
      this.$api({
        ...
        data: {
          ...this.pagination,
          order_status: this.tabSelect.value,
