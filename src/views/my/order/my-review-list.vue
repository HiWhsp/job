      ...
      <div class="wrap-comments" v-if="list_comment.length">
        <div class="comment-item" v-for="(item, index) in list_comment" :key="index">
          <div class="avatar-info">
            ...
            <div class="right">
              <el-rate v-model="item.star" disabled :colors="['#A66600', '#A66600', '#A66600']"
                text-color="#A66600"></el-rate>
            </div>
          </div>
          ...
          <div class="info-box">
            ...
            <div class="goods-info" @click="mix_to_product({ inventoryId: item.inventoryId })">
              ...
              <div class="goods-title">
                ...
                <div class="product-gugie">{{ item.productKeyVals }}</div>
              </div>
            </div>
          </div>
        </div>
...
<style scoped lang="less" src="@/assets/h5css/user/my-review-list.less"></style>
