  ...
  <div class="page">
    ...
    <div class="nav-bar">
      <el-breadcrumb separator=">">
        ...
        <el-breadcrumb-item><a href="/integralWinGoods">积分商城</a></el-breadcrumb-item>
        ...
        <div class="main-content">
          <div class="ctx-top">
            ...
            <div class="ctx-right">
              ...
              <div class="tip">
                <span>商品编码：{{ detail.sn }}</span>
              </div>
              <div class="price-wrap">
                <div class="price-text">
                  <div class="price-text-1">积分价格</div>
                  <div class="price-text-2">{{ detail.jifen }} 积分</div>
                </div>
              </div>
              <!--              汇总-->
              <div class="other-box">
                <div class="btn-box">
                  <button class="btn-ripple flex-center btn-buy" @click="payNow(detail)">
                    <img src="@/assets/img/productDetail/btn-icon.png" alt="">立即兑换
                  </button>
                </div>
              </div>
            </div>
