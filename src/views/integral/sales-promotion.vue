<template>
    <div class="body">
        ...
        <div class="box">
            ...
            <div class="roll-up">
                <div class="roll">
                    <div class="roll-coupon"> 优惠劵</div>
                    <div class="roll-title"> 满100减5元</div>
                    <div class="roll-price"> 
                        <spn style="font-size: 36px;">￥</spn>
                        <spn style="font-size: 76px; font-weight: 800;">5 </spn>
                    </div>
                    <div class="roll-get">立即领取</div>
                </div>
                <div class="roll">
                    <div class="roll-coupon"> 优惠劵</div>
                    <div class="roll-title"> 满500减10元</div>
                    <div class="roll-price"> 
                        <spn style="font-size: 36px;">￥</spn>
                        <spn style="font-size: 76px; font-weight: 800;">10</spn>
                    </div>
                    <div class="roll-get">立即领取</div>
                </div>
                <div class="roll">
                    <div class="roll-coupon"> 优惠劵</div>
                    <div class="roll-title"> 满1000减15元</div>
                    <div class="roll-price"> 
                        <spn style="font-size: 36px;">￥</spn>
                        <spn style="font-size: 76px; font-weight: 800;">5 </spn>
                    </div>
                ...
                <div class="roll">
                    <div class="roll-coupon"> 优惠劵</div>
                    <div class="roll-title"> 满15减5元</div>
                    <div class="roll-price"> 
                        <spn style="font-size: 36px;">￥</spn>
                        <spn style="font-size: 76px; font-weight: 800;">10</spn>
                    </div>
...
export default {
    data() {
        return {
            goodsList: Array.from({length: 10}, (_, i) => ({
                id: i+1,
                image: goodsImg, 
                name: '激光平面窗口 Ф5.0mm 厚', 
                price:5.25,
                integral: 5.25 
            }))
        };
