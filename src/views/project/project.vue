<template>
  <div class="page-wrap">
          ...
          <div class="table-box">
            <el-table :data="table_data" stripe>
              ...
              <el-table-column prop="content1" label="工程内容" align="center">
                <template slot-scope="scope">
                  <el-button type="text" @click="do_content(scope.row.content1, '工程内容')">查询详情</el-button>
                </template>
              </el-table-column>
              <el-table-column prop="content2" label="争议解决" align="center">
                <template slot-scope="scope">
                  <el-button type="text" @click="do_content(scope.row.content2, '争议解决')">查询详情</el-button>
                </template>
              </el-table-column>
    ...
    <project_content_modal ref="project_content_modal" />
    <project_process_modal ref="project_process_modal" />
  </div>
</template>
