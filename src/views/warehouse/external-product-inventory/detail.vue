        ...
        <el-tab-pane label="入库记录" name="in">
          ...
          <div class="table-box">
            ...
            >
              ...
              <el-table-column prop="yNum" label="变动前数量" min-width="110" align="center" show-overflow-tooltip />
              <el-table-column prop="xNum" label="变动后数量" min-width="110" align="center" show-overflow-tooltip />
              <el-table-column prop="created_at" label="时间" min-width="160" align="center" show-overflow-tooltip />
...
<script>
const DETAIL_API = '/getForeignProductKuCun';
const LOG_LIST_API = '/getForeignProductKuCunLogList';
const LOG_DETAIL_API = '/getForeignProductKuCunLog';

export default {
  name: 'ExternalProductInventoryDetail',
  ...
  methods: {
      ...
      return this.$api({
        ...
        .then(res => {
          if (res && res.code === 200 && res.data) {
            const d = res.data;
            const fp = d.foreign_product || {};
            this.foreignProductId = d.foreignProductId != null ? String(d.foreignProductId) : '';
            this.productInfo = {
              code: fp.productNo || '',
              name: fp.title || '',
              spec: fp.keyVals || '',
    ...
    loadInList() {
      ...
      this.$api({
        ...
        method: 'post',
        data: {
          foreignProductId: this.foreignProductId,
    ...
    fillLogDetailDrawer(d, which) {
      ...
      this.logDetailGoodsList = [
        {
          productName: fp.title || this.productInfo.name,
          spec: fp.keyVals || this.productInfo.spec,
          unit: fp.unit || this.productInfo.unit,
