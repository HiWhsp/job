    ...
    <div class="table-view">
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="purchaseNo" label="采购单号" min-width="140" show-overflow-tooltip />
          <el-table-column prop="productName" label="外购产品名称" min-width="140" show-overflow-tooltip />
...
<script>
export default {
  name: "WarehouseExternalPurchaseSingleInStorage",
  data() {
    return {
      queryParams: {
        keyword: "",
