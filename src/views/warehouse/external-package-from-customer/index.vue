    ...
    <div class="table-view">
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="packageName" label="包装名称" min-width="120" show-overflow-tooltip />
          <el-table-column prop="customerName" label="客户名称" min-width="120" show-overflow-tooltip />
          <el-table-column prop="inventory" label="库存数量" width="100" align="right" />
...
<script>
export default {
  name: "WarehouseExternalPackageFromCustomer",
  data() {
    return {
      queryParams: {
        keyword: "",
