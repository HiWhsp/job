        ...
        <div class="form-wrap">
            ...
            <el-form ref="form" :model="form" :rules="rules" label-position="top">
                <div class="form-flex">
                    ...
                    <el-form-item label="公司名称" class="flex-item" prop="company">
                        <el-input v-model="form.company"></el-input>
                    </el-form-item>
                </div>
                <div class="form-flex">
                    <el-form-item label="地址" class="flex-item" prop="address">
                        <el-input v-model="form.address"></el-input>
                    </el-form-item>
                    <el-form-item label="联系方式" class="flex-item" prop="phone">
