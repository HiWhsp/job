  ...
  data() {
    return {
      ...
      form: {
        ...
        businessLicenseList: [],
        medicalLicenseList: [],
        businessLicense: "", // 营业执照图片 URL，提交用
        medicalLicense: "", // 许可证图片 URL，多张英文逗号隔开，提交用
        accountName: "",
        accountNo: "",
        bankName: "",
        address: "",
      ...
      axios
        ...
        .then(res => {
          ...
          if (field === "businessLicense") {
            ...
            const arr = this.form.medicalLicense
              ? this.form.medicalLicense.split(",").filter(Boolean)
              : [];
            arr.push(url);
