<template>
  <el-drawer
    ...
    direction="rtl"
    size="640px"
    custom-class="external-product-detail-drawer-wrap"
    @close="handleClose"
  >
          ...
          <div class="detail-section-content">
            <div class="detail-row two-col">
              <div class="detail-item">
                ...
                <span class="detail-value">{{ merged.productNo || "—" }}</span>
              </div>
              <div class="detail-item">
            ...
            <div class="detail-row two-col">
              <div class="detail-item">
                ...
                <span class="detail-value">{{ merged.keyVals || "—" }}</span>
              </div>
              <div class="detail-item">
...
<script>
export default {
  name: "ExternalProductDetailDrawer",
  ...
  computed: {
    ...
    merged() {
      ...
      const d = this.detail || {};
      return {
        productNo: d.productNo ?? r.productNo,
        title: d.title ?? r.title,
        keyVals: d.keyVals ?? r.keyVals,
        unit: d.unit ?? r.unit,
      ...
      this.$api({
        ...
        .then(res => {
          if (res && res.data) {
            ...
            this.$message.error((res && res.msg) || "获取外购产品详情失败");
          }
        })
        .catch(() => {
...
<style lang="less">
.external-product-detail-drawer-wrap {
  .el-drawer__body {
    overflow: auto;
    position: relative;
  }
