      ...
      <div v-loading="detailLoading" class="detail-body">
        ...
        <div v-else-if="detailRow">
          <div class="detail-row">
            ...
            <div class="detail-item">
              <span class="detail-label">采购名称:</span>
          ...
          <div class="detail-section">
            <div class="detail-section-title">设备明细</div>
            <el-table :data="productList" border size="mini" class="detail-table">
              <el-table-column prop="title" label="设备名称" min-width="160" show-overflow-tooltip />
...
const PAY_API = "/payPurchaseEquipmentOrder";

export default {
  name: "DevicePurchasePayment",
  data() {
    return {
