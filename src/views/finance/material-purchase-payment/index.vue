<template>
  <div class="view-wrap finance-page">
    <div class="search-section">
      <el-form :model="queryParams" ref="queryForm" inline class="search-form" label-width="80px">
        <div class="search-row">
          <el-form-item label="采购单号" prop="keyword">
            <el-input
    ...
    <div class="page-title">原材料采购单付款</div>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column label="操作" width="120" align="center" fixed="right">
            <template slot-scope="{ row }">
              <span class="row-acts">
                <span v-if="row.status === '待付款'" class="row-act" @click="handlePay(row)">付款</span>
...
.table-box {
  ...
  ::v-deep .el-table__body tr.row-even td { background: #f3f7fa; }
