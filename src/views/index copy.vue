      ...
      <div class="inner">
          ...
          <div class="lunbo-wrap">
            ...
            <div class="lunbo-cont">
              ...
              >
                ...
                <div class="lunbo-center" v-if="!show_float">
                  <div class="lunbo-box">
                    <el-carousel trigger="click" :autoplay="true">
                      <el-carousel-item
                ...
                <div class="lunbo-right">
                  <div class="right">
                    <div class="user-box">
                      ...
                      <div class="tip-box">
                        <template v-if="!vuex_is_login"
                          >Hi 欢迎来到中科星选</template
                        >
                        <template v-else>
                          <p>Hi，{{ vuex_user.name }}</p>
                          <p>欢迎来到中科星选</p>
                        </template>
                      </div>
                      <template v-if="!vuex_is_login">
                        <div class="login-box">
                          <div
                            class="btn btn-ripple flex-center"
                            @click="$router.push('/login')"
                          >
                            登录
                          </div>
                        </div>
                        <div class="reg-box flex-between">
                          <div
                            class="btn btn-ripple flex-center"
        ...
        <div class="content-box w-1400">
          ...
          <div class="hot-tags">
            <div class="tag-wrap">
              <div class="tag-title">
                <span class="title-1 title-color">星选</span>
                <span class="title-2">推荐</span>
                <span class="desc">中科星选 为您推荐</span>
              </div>
              <div class="tag-box">
                <div class="tag-lunbo bg-green">
                  <el-carousel
                    ref="hotLunbo"
                    trigger="click"
                    :autoplay="true"
                  ...
                  >
                    <el-carousel-item
                      v-for="(item, gindex) in tuijian_lunbo_list"
                      :key="gindex"
                    >
                ...
                <div class="product-list">
                  <div
                    class="product-item"
                    v-for="(item, index) in tuijian_product_list"
                    :key="index"
                    @click="to_product(item)"
                  >
                    <div class="poster-box scale-box">
            ...
            <div class="tag-wrap">
              <div class="tag-title">
                <span class="title-1 title-color">星选</span>
                <span class="title-2">热销</span>
                <span class="desc">热销产品 好品快享</span>
              </div>
              <div class="tag-box">
                <div class="tag-lunbo bg-orange">
                  <el-carousel
                    ref="hotLunbo"
                    trigger="click"
                    :autoplay="true"
                  ...
                  >
                    <el-carousel-item
                      v-for="(item, gindex) in rexiao_lunbo_list"
                      :key="gindex"
                    >
                      <div class="product-lunbo">
                        <div
                ...
                <div class="product-list">
                  <div
                    class="product-item"
                    v-for="(item, index) in rexiao_product_list"
                    :key="index"
                    @click="to_product(item)"
                  >
                    <div class="poster-box scale-box">
            ...
            <div class="tag-wrap">
              <div class="tag-title">
                <span class="title-1">产地</span>
                <span class="title-2 title-color">直销</span>
                <span class="desc">兴农助农 产地直销</span>
              </div>
              <div class="tag-box">
                <div class="tag-lunbo bg-green">
                  <el-carousel
                  ...
                  >
                    <el-carousel-item
                      v-for="(item, gindex) in zhixiao_lunbo_list"
                      :key="gindex"
                    >
                      <div class="product-lunbo">
                        <div
                ...
                <div class="product-list">
                  <div
                    class="product-item"
                    v-for="(item, index) in zhixiao_product_list"
                    :key="index"
                    @click="to_product(item)"
                  >
                    <div class="poster-box scale-box">
          ...
          <div class="group-panel">
            ...
            >
              <div class="sec-title-box">
                ...
                <div class="sec-more" @click="to_cate_group(group)">
...
export default {
  ...
  data() {
    return {
      ...
      //
      haowu_product_list: [],
      tuijian_product_list: [],
      tuijian_lunbo_list: [],
      rexiao_product_list: [],
      rexiao_lunbo_list: [],
      zhixiao_product_list: [],
      zhixiao_lunbo_list: [],
      //
  ...
  methods: {
    ...
    query_tuijian() {
      this.$api({
        ...
        if (res.code == 200) {
          let list = res.data.list;
          this.tuijian_lunbo_list = list.slice(0, 4);
          this.tuijian_product_list = list.slice(4,10);
        }
      });
    },
    ...
    query_rexiao() {
      this.$api({
        ...
        if (res.code == 200) {
          let list = res.data.list;
          this.rexiao_lunbo_list = list.slice(0, 4);
          this.rexiao_product_list = list.slice(4,10);
        }
      });
    },
    ...
    query_zhixiao() {
      this.$api({
        ...
        if (res.code == 200) {
          let list = res.data.list;
          this.zhixiao_lunbo_list = list.slice(0, 4);
          this.zhixiao_product_list = list.slice(4,10);
        }
      });
    },
...
.hot-sec {
  ...
  border-radius: 8px 8px 8px 8px;
  background: linear-gradient(139deg, #ffb74b 0%, #ff7600 100%);
  height: 356px;
  padding: 6px;
    ...
    .tag-box {
      ...
      .tag-lunbo {
        ...
        &.bg-orange {
          background: linear-gradient(
            180deg,
            rgba(255, 118, 0, 0.2) 0%,
            rgba(255, 118, 0, 0) 100%
          );
        }
