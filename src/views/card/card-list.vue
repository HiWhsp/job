            ...
            <div class="list-wrap">
              <div class="jilu-list">
                <div class="item item-title">
                  ...
                  <div class="item-4" v-if="tab_select.status == '2'">操作</div>
                </div>
                <div
                  class="item-box"
                ...
                >
                  <div class="item item_other">
                    ...
                    <div class="item-4" v-if="tab_select.status=='2'">
                      <div class="btn" @click="toGoods(item)">兑换商品</div>
                      <div class="btn" @click="toRecords(item)">兑换记录</div>
                    </div>
                  </div>
                </div>
              </div>
