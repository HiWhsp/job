...
export default {
  ...
  data() {
    return {
      ...
      list_tab: [
        {title: "全部", status: "0"},
        {title: "供应商暂存", status: "1"},
        {title: '待寄回分部', status: '2'},
        {title: '寄回中', status: '3'},
        {title: '完成回收', status: '4'},
      ],
      keyword: '',
    ...
    <div class="section-order">
      ...
      <div class="order-box">
        <el-table :data="list_order" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="if_recover" label="回收状态">
            <template slot-scope="scope">
          ...
          <el-table-column prop="contact_address" label="寄送地址"></el-table-column>
          <el-table-column label="操作" fixed="right">
            <template slot-scope="scope">
              <el-button type="text" size="mini"
                         @click="goUrl('/supplier-order-detail?type=10&status=' + selectTab.status)">详情
              </el-button>
            </template>
          </el-table-column>
        </el-table>
