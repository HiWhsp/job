            ...
            <div class="info-item scroll-target-pingzheng">
              ...
              <div class="info-val">
                <el-upload class="upload-demo" list-type="picture-card" multiple accept="image/*"
                  :limit="upload_limit_number" :name="upload_col_name" :action="uploadAction" :data="uploadExtraData"
                  :on-success="uploadSuccess_pingjia" :before-upload="beforeUpload_pingjia"
                ...
                <div class="section-item" v-if="list_coupon.length">
                  ...
                  <div class="yhq-select-info">
                    ...
                    <template v-if="coupon_select.id">
                      <b class="number">{{ vuex_huobi }}{{ +coupon_select.jian }}</b>, 使用【{{ coupon_select.title }}】优惠券
                      1张，优惠
...
export default {
  ...
  data() {
    return {
      ...
      payTypeOption: [
        // { value: 'weixin', title: '微信支付', icon: require('@img/pay-wx.png') },
        // { value: 'zhifubao', title: '支付宝支付', icon: require('@img/pay-wx.png') },
        // { value: 'xianxia', title: '线下转款', icon: require('@img/pay-wx.png') },
