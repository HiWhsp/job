        ...
        <div class="input-wrap">
          ...
          <el-form ref="form" :model="form" :rules="rules" class="demo-ruleForm" label-width="0px">
            ...
            <el-form-item prop="mobile">
              <el-input v-model="form.mobile" placeholder="请输入注册电话号码"></el-input>
            </el-form-item>
            ...
            <el-form-item v-if="form.type == 1">
              <el-select v-model="form.materialTypeNames" multiple placeholder="请选择经营范围">
...
export default {
  ...
  methods: {
    retrieve_submit() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          if(this.form.materialTypeIds==''){
            this.form.materialTypeIds = this.form.materialTypeIds.join(",")
          }
    ...
    handleSuccess(res, file, fileList) {
      ...
      if(res.code==200){
        alertSucc(res.msg)
        this.form.licenseUrl =res.data.save_url
      }else{
        alertErr(res.msg)
        this.$refs.refFile.uploadFiles.splice(this.$refs.refFile.uploadFiles.indexOf(file), 1);
      }
    },
    //更新当前父组件数据
