<template>
  <div class="page">
    <div class="main-title flex">
      <span>Commission-only Reps</span>
    </div>

    <div class="page-ctx">
      <!-- 修改按钮 -->
      <div class="modify-btn" v-if="isUploadDisabled" @click="isUploadDisabled = !isUploadDisabled">Change information</div>
      <!-- 表单页面 -->
      <el-form :model="form" :rules="rules" ref="partTimeSalesForm" label-width="0">
        ...
        <div class="form-section">
          ...
          <el-form-item prop="identityId">
            ...
            <el-input v-model="form.identityId" placeholder="Please enter" :disabled="isUploadDisabled"></el-input>
          </el-form-item>
        </div>
        ...
        <div class="form-section">
          ...
          <div class="btns_end" v-if="!isUploadDisabled" @click="handle_add">+&nbsp;&nbsp;Add Region</div>
          <div class="form_text" v-if="!isUploadDisabled">
        ...
        <!-- 协议同意 -->
        <div class="form-section" v-if="!isUploadDisabled">
        ...
        <div class="submit-section" >
          <el-button class="btn-submit" v-if="!isUploadDisabled" @click="do_submit()" :loading="loading">SUBMIT</el-button>
        </div>
      </el-form>
    </div>
  </div>
