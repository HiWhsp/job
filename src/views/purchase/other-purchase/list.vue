<template>
  <div class="view-wrap purchase-page">
    ...
    <div class="table-util-bar">
      <div class="list-title">其他采购采购单</div>
      <el-button type="primary" @click="handleAdd">新增其他采购采购单</el-button>
    </div>
    ...
    <div class="table-view">
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="purchaseName" label="采购名称" min-width="140" show-overflow-tooltip />
          ...
          <el-table-column prop="status" label="状态" width="120" align="center">
            <template slot-scope="{ row }">
              ...
              <el-tag v-else-if="row.status === '待财务付款'" type="warning" size="small" effect="plain">待财务付款</el-tag>
          ...
          <el-table-column label="操作" min-width="220" align="center" fixed="right">
            <template slot-scope="{ row }">
              <span class="row-acts">
                ...
                <span v-if="row.status === '待财务付款' || row.status === '采购中'" class="row-act" @click="handleComplete(row)">采购完成</span>
              </span>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        ...
        { id: 2, purchaseNo: "4521415", purchaseName: "采购名称", amount: "2500.00", status: "审核未通过", submitTime: "2026-01-05" },
        { id: 3, purchaseNo: "4521416", purchaseName: "采购名称", amount: "2500.00", status: "待财务付款", submitTime: "2026-01-05" },
        { id: 4, purchaseNo: "4521417", purchaseName: "采购名称", amount: "2500.00", status: "采购中", submitTime: "2026-01-05" },
        { id: 5, purchaseNo: "4521418", purchaseName: "采购名称", amount: "2500.00", status: "采购完成", submitTime: "2026-01-05" }
      ]
    };
  },
  mounted() {
  ...
  methods: {
    ...
    loadList() {
      // TODO: 调用其他采购采购单列表接口，传入 keyword、status、dateRange、pageNum、pageSize，赋值 tableData、total
    ...
    handleAdd() {
      this.$router.push({ name: "other-purchase-add" });
    },
    handleView(row) {
      this.$router.push({
        path: "/purchase/other-purchase/detail",
        query: { id: row.id }
      });
    },
    handleEdit(row) {
...
.table-box {
  ...
  ::v-deep .el-tag--warning.el-tag--plain {
