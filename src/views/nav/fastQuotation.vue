...
export default {
  ...
  methods: {
    ...
    // 上传文件回调
    uploadSuccess(e, item) {
      const formData = new FormData();
      formData.append('img', e.target.files[0]);
      axios.post('https://fjjx.dx.hdapp.com.cn/service.php?action=index_ossUpload', formData, {
        headers: {
  ...
  <div class="page">
    ...
    <div class="prod-wrap">
      <el-tabs v-model="activeName" @tab-click="handleClick">
                      ...
                      <el-col :span="3">
                        <div class="item file-item">
                          ...
                          >
                            ...
                            <span v-if="item.fileList.length" style="color: #014BC4;" class="ellipsis-2" slot="reference"
                                  @click="visible = true">{{ item.fileList[0].name }}</span>
                          </el-popover>

                          <span style="color: #014BC4;" @click="selectFile" v-if="!item.fileList.length">上传</span>
                          <input type="file" ref="fileInput" @change="uploadSuccess($event, item)"
                                 style="display: none;"/>
                        </div>
        ...
        <el-tab-pane label="已报价产品" name="second">
          <div class="batch-input">
            <div class="virtual-list">
              <div class="batch-title-box">
                <div class="left-box">
        ...
        <el-tab-pane label="需询价产品" name="third">
          <div class="batch-input">
            <div class="virtual-list">
              <div class="batch-title-box">
                <div class="left-box">
