    ...
    >
      <div class="modal-inner">
        ...
        <div class="modal-ctx">
            ...
            <div class="pic-list">
              ...
              >
                <div class="poster-box scale-box">
                  <img class="poster scale-img" :src="item.fileUrl" alt="" />
                </div>
                <div class="info-box">
                  <div class="title">{{ item.fileName }}</div>
                  <div class="check-box">
                    <el-checkbox
                      v-if="is_allow_multiple"
          ...
          <div class="pagi-box" v-if="is_allow_multiple">
            <div class="page-left">
              <el-checkbox
      ...
      <span slot="footer" class="dialog-footer" v-if="is_allow_multiple">
...
export default {
  ...
  methods: {
    ...
    do_delete_batch() {
      ...
      let keys = this.pic_list.filter((v) => v.is_select).map((v) => v.key);
      this.$api({
        url: "/common/delete/file",
        method: "post",
        data: {
