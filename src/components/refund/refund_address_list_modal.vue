  ...
  <div class="modal-container">
    ...
    >
        ...
        <div class="section">
          ...
          <div class="section-ctx">
            <div class="address-list">
              <div
                class="address-item"
                v-for="(item, index) in list_address_other"
                :key="index"
      ...
      <span slot="footer" class="dialog-footer">
        <button class="btn-ripple fit-text btn-1" @click="do_submit()">
          保 存
        </button>
  ...
  methods: {
    init(info) {
      if (info) {
        ...
        this.list_address_current =
          this.list_address.filter((v) => v.id == this.select_address_id) || [];
        this.list_address_other =
          this.list_address.filter((v) => v.id != this.select_address_id) || [];
