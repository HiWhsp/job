<template>
    <div class="modal-container">
        ...
        <button class="btn btn-ripple btn-1" @click="$router.push('/productCart')">查看购物车</button>
        <button class="btn btn-ripple btn-2" @click="onBeforeClose">继续购物</button>
      </span>
        </el-dialog>
    </div>
</template>
