			...
			<div class="modal-ctx" data-type="基础表单弹窗">
				<div class="input-items">
					<div class="input-item" v-for="(item, index) in form_fields" :key="index">
						<div class="input-box">
							<div class="label" :class="{ required: item.is_required_in_form }" :data-field="item.field">
								{{ item.field_title }}
							</div>
							...
							<div class="val">
								<div class="form-ele">
									...
									<!-- 多行文本 -->
									<div class="form-text" v-else-if="item.form_render_type == 'textarea'">
										{{form[item.field]}}
									</div>
									...
									<!-- 选项 -->
									<div class="form-text" v-else-if="item.form_render_type == 'select'">
										{{form[item.field]}}
									</div>
									...
									<!-- 单选 -->
									<!-- <div class="form-text" v-else-if="item.form_render_type == 'radio'">
										{{form[item.field]}}
									</div> -->
									<el-radio-group v-else-if="item.form_render_type == 'radio'"
										...
										<el-radio v-for="(radio_item, radio_index) in radio_options_map[item.field]"
											...
											v-if="form[item.field] === radio_item.value">
											{{ radio_item.title }}
										</el-radio>
									</el-radio-group>
									...
									<!-- 日期 时间 -->
									<div class="form-text" v-else-if="item.form_render_type == 'date'">
										{{form[item.field]}}
									</div>
									...
									<!-- 日期 时间 -->
									<div class="form-text" v-else-if="item.form_render_type == 'daterange'">
										{{form[item.field]}}
									</div>
									...
									<!-- 日期 时间 -->
									<div class="form-text" v-else-if="item.form_render_type == 'dateTimePicker'">
										{{form[item.field]}}
									</div>
									...
									<!-- 日期 时间 -->
									<div class="form-text" v-else-if="item.form_render_type == 'datetime'">
										{{form[item.field]}}
									</div>
                    ...
                    >
									...
									<!-- 图片展示 -->
									<div class="form-image-box" v-else-if="item.form_render_type == 'image'">
										<div class="image-list">
											<div class="image-item">
												<el-image style="width: 120px; height: 120px" :src="form[item.field]"
									...
									<!-- 图片展示 -->
									<div class="form-image-box" v-else-if="item.form_render_type == 'image-list'">
										<div class="image-list">
											<div class="image-item" v-for="(pic_item,pic_index) in form[item.field]">
												<el-image style="width: 120px; height: 120px" :src="pic_item"
													:preview-src-list="form[item.field]">
												</el-image>
											</div>
										</div>
	...
	export default {
		...
		methods: {
			initConfig(option) {
				...
				this.hidden_fields_in_detail = option.hidden_fields_in_detail || [];

				if (this.hidden_fields_in_detail.length) {
					this.form_fields = this.form_fields.filter(field_item => !this.hidden_fields_in_detail.includes(field_item
						.field))
				}
