<template>
  <div class="">
    <div class="upload-box">
      ...
      <div class="action">
        <el-upload name="img" :data="uploadExtraData" action="https://zsxhxxpx.dx.hdapp.com.cn/api?action=index_ossUpload"  :show-file-list="false" :on-success="onSuccess_upload" :before-upload="onBefore_upload">
          <slot></slot>
        </el-upload>
      </div>
    </div>
