...
const routes = [
    ...
    {
        path: "/company-news-detail", // 新闻详情
        name: "company-news-detail",
        component: () => import("@/views/chat-us/company-news-detail.vue"),
    },
    {
        path: "/exhibition-information-detail", // 展会详情
        name: "exhibition-information-detail",
        component: () =>
            import("@/views/chat-us/exhibition-information-detail.vue"),
    },
    ...
    // 联系我们
    {
        path: "/company",
        name: "company",
        component: () => import("@/views/chat-us/index.vue"),
        redirect: "/company-profile",
        children: [
            {
                path: "/company-profile", // 公司简介
                name: "company-profile",
                component: () => import("@/views/chat-us/company-profile.vue"),
            },
            {
                path: "/company-news", // 公司简介
                name: "company-news",
                component: () => import("@/views/chat-us/company-news.vue"),
            },
            {
                path: "/exhibition-information", // 公司简介
                name: "exhibition-information",
                component: () => import("@/views/chat-us/exhibition-information.vue"),
            }, {
                path: "/contact-us", // 公司简介
                name: "contact-us",
                component: () => import("@/views/chat-us/contact-us.vue"),
            }
        ]
    },
    // 光电计算
    {
        ...
        component: () => import("@/views/chat-us/light-computing.vue"),
    },
    // 激光加工
    {
        path: "/laser-processing",
        name: "laser-processing",
        component: () => import("@/views/chat-us/laser-processing.vue"),
    },
