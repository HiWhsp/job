...
const my_layout = () => import("@/views/layout/my_layout.vue");
// 视图页面
const index = () => import("@/views/index.vue");
const news = () => import("@/views/news/news.vue");
const news_detail = () => import("@/views/news/news-detail.vue");
...
const terms = () => import("@/views/article/terms.vue");
const help = () => import("@/views/article/help.vue");
const demand = () => import("@/views/company/demand.vue");

//产品
const product_cates = () => import("@/views/product/product-cates.vue");
const product_remai = () => import("@/views/product/product-remai.vue");
const product_youxuan = () => import("@/views/product/product-youxuan.vue");
const product_search = () => import("@/views/product/product-search.vue");
const product_detail = () => import("@/views/product/product-detail.vue");
const batch_search = () => import("@/views/batch/batch-xiadan.vue");
const batch_xunjia = () => import("@/views/batch/batch-xunjia.vue");
const batch_xunjia_match = () => import("@/views/batch/batch-xunjia-match.vue");
const batch_xunjia_result = () => import("@/views/batch/batch-xunjia-result.vue");
const product_xieyi = () => import("@/views/product/product-xieyi.vue");
const product_zhenxuan = () => import("@/views/product/product-zhenxuan.vue");
const scene = () => import("@/views/product/scene.vue");
const balance = () => import("@/views/balance/balance.vue");
const balance_list = () => import("@/views/balance/balance-list.vue");
const card = () => import("@/views/card/card.vue");
const card_list = () => import("@/views/card/card-list.vue");
const card_goods = () => import("@/views/card/card-goods.vue");
const card_records = () => import("@/views/card/card-records.vue");
const order_logistics = () => import("@/views/order/order-logistics.vue");
// const memberCenter = () => import( "@/views/my/member/memberCenter.vue");
...
const order_submit = () => import("@/views/order/order-submit.vue");
const payment_methods = () => import("@/views/payment/payment-methods.vue");
// 支付
// const zfbPay = () => import(/* webpackChunkName: "zfbPay" */ "@/views/pay/zfbPay.vue");
const payment_success = () => import("@/views/payment/payment-success.vue");
const order_list = () => import("@/views/order/order-list.vue");
const order_detail = () => import("@/views/order/order-detail.vue");
// const points-order-detail = () => import(/* webpackChunkName: "points-order-detail" */ "@/views/order/points-order-detail.vue");
const order_review_submit = () => import("@/views/review/order-review-submit.vue");
// 发票
const invoice_list = () => import("@/views/invoice/invoice-list.vue");
const invoice_detail = () => import("@/views/invoice/invoice-detail.vue");
// 售后
...
const refund_service_detail = () => import("@/views/refund/refund-service-detail.vue");
//
const address_list = () => import("@/views/address/address-list.vue");
const foreign_address_list = () => import("@/views/address/foreign-address-list.vue");
const my_info = () => import("@/views/my/my-info.vue");
const my_review_list = () => import("@/views/review/my-review-list.vue");
const change_password = () => import("@/views/my/change-password.vue");
const browse_history = () => import("@/views/browse/browse-history.vue");
const favorite_list = () => import("@/views/favorite/favorite-list.vue");
const footprint_list = () => import("@/views/footprint/footprint-list.vue");
    ...
    children: [
      ...
      //用户中心
      {
        ...
        children: [
          ...
          {
            path: "/commission-only-reps",
            name: "commission-only-reps",
            component: commissionOnlyReps,
            meta: {
              title: "成为佣金代理",
              requireAuth: true,
            },
