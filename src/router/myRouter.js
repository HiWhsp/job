export const myRouter = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "joinGroup",
        meta: {},
        component: () => import("@/views/my/group/joinGroup.vue"),
      },
      {
        path: "/createGroup", // 创建团体
        name: "createGroup",
        meta: {},
        component: () => import("@/views/my/group/createGroup.vue"),
      },
      {
        path: '/groupManage', // 团体管理
        name: 'groupManage',
        meta: {},
        component: () => import("@/views/my/group/groupManage.vue"),
      },
      {
        path: '/groupRights', // 团体权益
        name: 'groupRights',
        meta: {},
        component: () => import("@/views/my/group/groupRights.vue"),
      },
      {
        path: "/order", // 我的订单
        name: "order",
